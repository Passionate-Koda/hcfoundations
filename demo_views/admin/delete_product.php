...
deleteContents($conn,$_GET['id'],$_GET['t']);
logs($conn, 'deleted', $edit_info['product_name'],'product',$hash_id);
$succ = "Success";
...
<h2 class="title-2">Are You Sure You Want to delete "<?php echo $edit_info['product_name'] ?>"</h2>
