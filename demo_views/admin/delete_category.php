...
deleteCategory($conn,$edit_info['image_1'],$_GET['id']);
logs($conn, 'deleted', $edit_info['title'],'exploits',$hash_id);
}
...
<h2 class="title-2">Are You Sure You Want to delete "<?php echo $edit_info['category_name'] ?>"</h2>
