...
<meta name="author" content="Hathany Cosmos Foundations">
<title>Hathany Cosmos Foundations Web Office </title>
...
<h2 class="page-title">Login to your the The System Web Office</h2>
</div>
</div>
</div>
</div>
...
<p>We will verify your account once you are confirmed as a Hathany Cosmos Foundations Admin. You will be Notified via mail. Thanks</p>
</div>
</div>
</div>';
}
...
<div class="alert alert-warning alert-lg" role="alert">
<h2 class="postin-title">Warning! '.$msg.' </h2>
<p>Hathany Cosmos Foundations admin pages cannot be accessed without signin. Thanks</p>
</div>
</div>
</div>';
}
...
<div class="alert alert-warning alert-lg" role="alert">
<h2 class="postin-title">Warning! '.$msg.' </h2>
<p>Contact Hathany Cosmos Foundations Admin. Thanks</p>
</div>
</div>
</div>';
}
