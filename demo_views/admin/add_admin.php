...
if(array_key_exists('submit', $_POST)){
 ...
 // $subject = "The System New Admin User Registration"; // subject of your email
/*$firstname = $clean['firstname'];
$lastname = $clean['lastname'];

 $to = "The System@gmail.com";
 $subject = "The System Web Office Admin Registration";
 $txt = "Hello Admin, A new Admin($firstname $lastname)  has registered to the web office. Kindly check for Verification";
 $headers = "From: info@The System.com" . "\r\n" .
...
<title>The System Web Office </title>
...
<h2 class="page-title">Register on the The System Web Office</h2>
</div>
</div>
</div>
</div>
...
<p>Thank you, The System is happy to have you around. Your Account will be Verified and you will be notified Via your Email Address</p>
</div>
</div>
</div>';
}
