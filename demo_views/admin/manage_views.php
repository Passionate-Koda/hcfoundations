...
<p>Thank you '.ucwords($firstname).', Hathany Cosmos Foundations is happy to have you around. </p>
 ...
 <div  class="alert alert-info" role="alert">
  <strong>NOTE</strong>
  <p><strong>*</strong>This SLIDER is displayed on the Home Page of the Hathany Cosmos Foundationspage</p>
...
echo $display ?>
<div class="form-group mb30">
<label class="control-label">Text</label>(Add Just One Paragraph here, to avoid page distortion)
