...
if(array_key_exists('submit', $_POST)){
  ...
  if(empty($error)){
    ...
    addCategory($conn, $clean,$hash_id);
  }
}
 ?>
<section id="content">
...
<h2 class="title-2">Welcome to the Category Page</h2>
<div class="row search-bar mb30 blue">
<div class="advanced-search">

<div class="col-md-4 col-sm-12 search-col">
<h3>Please add category</h3>
</div>
...
<label class="control-label">Category Name</label><?php $display = displayErrors($error, 'category');
echo $display ?> <input class="form-control input-md" name="category" placeholder="Enter a category name"  type="text">
</div>
