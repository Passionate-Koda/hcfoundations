...
if(array_key_exists('submit', $_POST)){
  ...
  if(empty($error)){
    ...
    //  $subject = "The System Web Office Content Upload";
...
echo $display ?> <input class="form-control input-md" name="author" placeholder="Enter your service details here"  type="text">
