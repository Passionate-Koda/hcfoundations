...
// 
// $to = $email;
// $subject = "Admin Web Office Sharer Verification";
// $txt = "Hello $firstname $lastname, You have been Verified from the Admin Web Office to earn from sharing Posts. Login at https://Admin.com/userLogin";
...
//  $subject = "Admin VERIFICATION"; // subject of your email
//
// $headers = array ('From' => $from,'To' => $to, 'Subject' => $subject);
//
// // $text = ''; // text versions of email.
// $html = "<html><body>Hello, $firstname $lastname <br>You have been verified at the Admin Web Office. You can now login to the Web Office at \"https://news.mckodev.com.ng/adminLogin"; // html versions of email.
//
// $crlf = "\n";
//
