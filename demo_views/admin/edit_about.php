  ...
  <div class="container">
    <div class="row">
      <?php if (isset($_GET['success'])){
        ...
        <p>Thank you '.ucwords($firstname).', System is happy to have you around. </p>
        </div>
        </div>
        </div>';
      } ?>
        ...
        <div class="page-ads box">
          ...
          <form class="form-ad" action="" method="post">
            <div class="form-group mb30">
              ...
              echo $display ?>
              <textarea class="form-control"  id="editor" name="about" value="<?php echo $edit_info['body'] ?>" placeholder="Write about the Event here" rows="4"><?php echo $edit_info['body'] ?></textarea>
            </div>
