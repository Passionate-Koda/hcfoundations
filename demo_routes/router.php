...
//   case "":
// include APP_PATH."/views/users/payment.php";
//   break;
  ...
  break;
  case "upload2server":
  include APP_PATH."/demo_views/admin/upload2server.php";
  break;
  case "addCampusNews":
  ...
  break;
  case "multiple":
  include APP_PATH."/demo_views/admin/multiple_image.php";
  break;
  case "multiple?id=$id":
  include APP_PATH."/demo_views/admin/multiple_image.php";
  break;
  case "multiple?success=$success":
  include APP_PATH."/demo_views/admin/multiple_image.php";
  break;
