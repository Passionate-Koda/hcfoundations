...
$rf = strip_tags($bd);
$tn = $site_name."(Resources) - ".ucwords($name);

echo '<title>'.$site_name."(Resources) - ".ucwords($name).'</title>
...
echo '<meta property="og:title" content="'.$site_name."(Resources) - ".ucwords($name).'" />
...
<meta name="twitter:title" content="'.$site_name."(Resources) - ".ucwords($name).'">
