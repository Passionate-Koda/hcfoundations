...
$page_name = "event";
if (isset($_GET['id'])) {
    $event = selectContent($conn,'panel_event',["hash_id"=>$_GET['id']]);
...
extract($event[0]);
 ...
 header("Location:/event");
  ...
  // $recent = recenteventPost($conn);

   // $recent = recenteventPost($conn);
   $recent = selectContentDesc($conn,"panel_event",[],"id",3);
 ...
 <div class="clearfix">
        ...
        <div class="container section-34 section-sm-50">
          <div class="row align-items-xl-center">
            <div class="col-xl-5 d-none d-xl-block text-xl-left">
              <h2><span class="big">Event</span></h2>
            </div>
            ...
            <div class="offset-top-0 offset-md-top-10 col-xl-5 offset-xl-top-0 small text-xl-right">
              <ul class="list-inline list-inline-dashed p">
                ...
                <li class="list-inline-item">Events
                </li>
              </ul>
            </div>
          </div>
      ...
      <section class="section novi-background section-98 section-110">
        <div class="container">
          <h1><?php echo $input_event_name ?></h1>
              ...
              <div id="inside-div" class="row">
                <div class="container">
                  ...
                  <div class="row offset-top-66 justify-content-sm-center text-left">
                    ...
                    <div class="col-sm-10 col-md-6 col-lg-3 offset-top-50 offset-md-top-0"><a class="thumbnail-classic" href="eventView?id=<?php echo $value['hash_id'] ?>" target="_blank">
                              <figure><img width="370" height="278" src="<?php echo $value['image_1']?>" alt="">
                              </figure></a>
                      <div>
                        <h6 class="offset-top-24"><a href="eventView?id=<?php echo $value['hash_id'] ?>"><?php echo $value['input_event_name'] ?></a></h6>
                      </div>
                      <p class="text-dark offset-top-4 text-extra-small"><?php echo $value['input_event_location'] ?></p>
                    </div>
                       <?php endforeach; ?>
        ...
        <div class="container">
          ...
          <div class="row offset-top-66 justify-content-sm-center text-left">
            ...
            <div class="col-sm-10 col-md-6 col-lg-3 offset-top-50 offset-md-top-0"><a class="thumbnail-classic" href="eventView?id=<?php echo $value['hash_id'] ?>" target="_blank">
              ...
              <div>
                <h6 class="offset-top-24"><a href="eventView?id=<?php echo $value['hash_id'] ?>"><?php echo $event_name ?></a></h6>
              </div>
              <p class="text-dark offset-top-4 text-extra-small"><?php echo $event_location ?></p>
            </div>
               <?php endforeach; ?>
