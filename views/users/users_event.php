...
$page_name = "anything";
  ...
  $row = selectContent($conn,'panel_event',[]);
 ?>
 <div class="clearfix">
         ...
         <div class="col-md-10 col-lg-12">
           <div class="row">
             ...
             <div class="col-lg-6 col-xl-4" style="margin-top:5px;">
                     <!-- Post Boxed--><a class="d-block" href="eventView?id=<?php echo $value['hash_id'] ?>">
                         ...
                         <section class="post-content text-left">
                           ...
                           <div class="post-body">
                             ...
                             <div class="post-title">
                               <h3 title="<?php echo $value['input_event_name'] ?>"><?php echo $value['input_event_name'] ?></h3>
                             </div>
                             <div class="post-meta small">
                               <ul class="list-inline list-inline-sm p">
                                 <li class="list-inline-item font-italic text-middle"><span class="text-picton-blue"><?php echo $value['input_event_location'] ?></span></li>
