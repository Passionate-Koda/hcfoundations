...
$rf = strip_tags($bd);
$tn = $site_name."(Event) - ".ucwords($input_event_name);

echo '<title>'.$site_name."(Event) - ".ucwords($input_event_name).'</title>
<meta name="format-detection" content="telephone=no"/>
<meta name="viewport" content="width=device-width, height=device-height, initial-scale=1.0"/>
<meta http-equiv="X-UA-Compatible" content="IE=edge"/>';
$cut = explode(' ',$input_event_name);
$metakeys = implode(',',$cut).",";
echo '<meta name="description" content="'.$rf.'" />
<meta name="keywords" content="'.$metakeys.'blog">';
echo '<meta property="og:title" content="'.$site_name."(Event) - ".ucwords($input_event_name).'" />
...
<meta name="twitter:title" content="'.$site_name."(Event) - ".ucwords($input_event_name).'">
