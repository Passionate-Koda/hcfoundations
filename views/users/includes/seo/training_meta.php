...
$rf = strip_tags($bd);
$tn = $site_name."(Training) - ".ucwords($name);

echo '<title>'.$site_name."(Training) - ".ucwords($name).'</title>
...
echo '<meta property="og:title" content="'.$site_name."(Training) - ".ucwords($name).'" />
...
<meta name="twitter:title" content="'.$site_name."(Training) - ".ucwords($name).'">
