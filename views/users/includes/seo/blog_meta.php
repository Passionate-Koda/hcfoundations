...
$bd = previewBody($text_body, 22);
$rf = strip_tags($bd);
$tn = $site_name." - ".ucwords($input_title);

echo '<title>'.$tn.'</title>
<meta name="format-detection" content="telephone=no"/>
<meta name="viewport" content="width=device-width, height=device-height, initial-scale=1.0"/>
<meta http-equiv="X-UA-Compatible" content="IE=edge"/>';
$cut = explode(' ',$input_title);
$metakeys = implode(',',$cut).",";
echo '<meta name="description" content="'.$rf.'" />
<meta name="keywords" content="'.$metakeys.'blog">';
echo '<meta property="og:title" content="'.$site_name." - ".ucwords($input_title).'" />
...
<meta name="twitter:title" content="'.$site_name." - ".ucwords($input_title).'">
