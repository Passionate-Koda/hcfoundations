...
$html = "<html><body><p>Registration Detail for KIMTEYG Event</p>First Name: ".$_POST['firstname']."<br>Surname: ".$_POST['lastname']." <br>Age: ".$_POST['age']." <br>Sex: ".$_POST['sex']." <br>Residential Address: ".$_POST['address']."<br> Name of School: ".$_POST['school']."<br> How did you hear about the program: ".$_POST['how']."<br> Phone Number: ".$_POST['phonenumber']."<br>Parents/Guardian:".$_POST['pphonenumber']."</p></body></html>"; // html versions of email.
...
if (PEAR::isError($mail)) {
 ...
 $msg['done'] = "Registration Successful";
              ...
              <div class="col-sm-8 col-md-6 col-lg-4">
                ...
                <?php } ?>
                  <div class="text-center">
                            ...
                            <div>
                              <div class="offset-top-24 text-darker big font-weight-bold">Register for Hathany Cosmos Foundations Program</div>
                  ...
                  <form class="text-left offset-top-30" action="" method="post">
                    ...
                    <div class="form-group">
                      <div class="input-group input-group-sm"><span class="input-group-prepend"><span class="input-group-text input-group-addon-inverse"><span class="novi-icon mdi mdi-account-outline"></span></span></span>
                        <input class="form-control"  placeholder="Sex" type="text" name="sex" required>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      <div class="input-group input-group-sm"><span class="input-group-prepend"><span class="input-group-text input-group-addon-inverse"><span class="novi-icon mdi mdi-account-outline"></span></span></span>
                        <input class="form-control"  placeholder="Age" type="text" name="age" required>
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="input-group input-group-sm"><span class="input-group-prepend"><span class="input-group-text input-group-addon-inverse"><span class="novi-icon mdi mdi-account-outline"></span></span></span>
                    ...
                    <div class="form-group">
                      <div class="input-group input-group-sm"><span class="input-group-prepend"><span class="input-group-text input-group-addon-inverse"><span class="novi-icon mdi mdi-account-outline"></span></span></span>
                        ...
                        <textarea name="how" class="form-control"  placeholder="How did you hear about the program" rows="8" cols="80"></textarea>
                      </div>
                    </div>
